...
const React = window.Guildium.getApiProperty("react"),
    ...
    { default: BannerWithButton } = window.Guildium.getApiProperty("guilded/components/BannerWithButton");

export default class AddonView extends EnhancementView<Addon> {
    protected type = "addon";
    protected enhancementHandler = window.Guildium.addons;
    ...
    protected override renderTabs(addon: Addon) {
        ...
        return (
            <div className="GuildiumEnhancementPage-tab">
                { requiredPermissions
                    ? <>
                        <BannerWithButton theme="warning" iconName="icon-filter" className="GuildiumEnhancementPage-warning" text="Basic information that can't be used maliciously will be given by default. Please DO NOT give a permission to an addon if you do not know how it will be used."/>
