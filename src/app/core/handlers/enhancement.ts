...
/**
 * Manages different components of Guildium to allow them to be extended.
 */
export default abstract class EnhancementHandler<
    T extends AnyEnhancement,
    C extends RGEnhancementConfig<T>,
    S extends GuildiumEnhancementSettings = GuildiumEnhancementSettings
> extends AbstractEventTarget {
     ...
     */
    constructor(parent: Guildium, settings: S, settingsHandler: SettingsHandler, config: C) {
        super();
    ...
    /**
     * Loads all Guildium enhancements onto Guilded.
     */
    loadAll(): void {
    ...
    /**
     * Removes Guildium themes from Guilded.
     */
    unloadAll(): void {
