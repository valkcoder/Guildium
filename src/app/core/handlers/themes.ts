import { GuildiumEnhancementSettings } from "../../../common/guildium-settings.js";
import { RGThemeConfig } from "../../types/guildium.js";
import { Theme } from "../../../common/enhancements.js";
import EnhancementHandler from "./enhancement.js";
import SettingsHandler from "./settings.js";
import Guildium from "../Guildium.js";

/**
 * Manager that manages Guildium's themes
 */
export default class ThemeHandler extends EnhancementHandler<Theme, RGThemeConfig> {
    ...
    /**
     * Manager that manages Guildium's themes
     * @param parent The parent Guildium instance
     * @param themesDir The directory of the Guildium themes
    ...
    constructor(
        parent: Guildium,
        settings: GuildiumEnhancementSettings,
    ...
    /**
     * Initiates themes for Guildium and theme manager.
     */
    ...
    /**
     * Loads a Guildium theme
     * @param metadata The Guildium theme to load
     */
    ...
    async addStyleSheets(metadata: Theme) {
        ...
        const group = Object.assign(document.createElement("datagroup"), {
            id: `GuildiumStyleTheme-theme-${metadata.id}`,
            classList: "GuildiumStyle-theme"
        });
        ...
        for (let css of metadata.css)
            group.appendChild(
                Object.assign(document.createElement("style"), {
                    classList: "GuildiumStyleTheme-css",
                    innerHTML: css
                })
            );
    ...
    checkAndDoSettings(metadata: Theme, group: Element) {
        ...
        group.appendChild(
            Object.assign(document.createElement("style"), {
                id: "GuildiumStyleTheme-settings",
                // #app { --a: b; --c: d }
    ...
    private unloadWithId(themeId: string) {
        ...
        const themeElement = document.getElementById(`GuildiumStyleTheme-theme-${themeId}`);
