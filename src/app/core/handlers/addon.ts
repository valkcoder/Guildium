import { GuildiumAddonSettings } from "../../../common/guildium-settings";
import { RGAddonConfig } from "../../types/guildium";
...
import Guildium from "../Guildium";

/**
 * Manager that manages Guildium's addons
 */
export default class AddonHandler extends EnhancementHandler<Addon, RGAddonConfig, GuildiumAddonSettings> {
    initialized: string[] = [];
    ...
    constructor(
        parent: Guildium,
        settings: GuildiumAddonSettings,
    ...
    /**
     * Initiates addons for Guildium and addon manager
     */
    ...
    /**
     * Unloads/removes a Guildium addon.
     * @param metadata addon to load onto Guilded
     */
